...
public class WordPuzzleTester {
	public static void main(String[] args) {
		...
		for (int j = 0; j < 100; j++){
			...
			boolean case1 = (correctGuesses.contains("" + hint[0]) && !incorrectGuesses.contains("" + hint[1]));  //first char is correct
			boolean case2 = (correctGuesses.contains("" + hint[1]) && !incorrectGuesses.contains("" + hint[0]));  //first char is incorrect
			if (!case1 && !case2){
				cnt++;
				System.out.println("Error 5.1");
				System.out.println("[0]: " + hint[0] + "," + " [1]: " + hint[1] );
